...
function Signup() {
  ...
  const handleSubmit = () => {
    ...
    // You can add more validations here (e.g. regex for email/password rules)
    ...
    <div className="flex flex-col justify-center items-center min-h-screen px-4">
      ...
      <div className="text-center w-full max-w-md">
        ...
        <button
          ...
          className="text-sm border h-[50px] w-full rounded-[10px] text-white bg-black border-black mt-3"
        >
          Continue
        </button>
        ...
        <div className="flex py-10 gap-1 justify-center">
          <p>Have an account?</p>
          <p className="text-blue-500 decoration-double font-serif cursor-pointer">Login here</p>
        </div>
